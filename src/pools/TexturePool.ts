...
export class TexturePool extends Pool<Texture, TextureParams> {
  static createParams(
    ...
    const transform = textureInfo.getExtension<Transform>(
    ...
    return {
      ...
      minFilter:
        WEBGL_FILTERS[textureInfo.getMinFilter() as number] ||
        LinearMipmapLinearFilter,
      magFilter:
        WEBGL_FILTERS[textureInfo.getMagFilter() as number] || LinearFilter,
